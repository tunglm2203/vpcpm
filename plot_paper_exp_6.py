...
def plot_multiple_results(directories):
    ...
    color_table = ['#9f4800', '#023eff', '#e8000b']
    linestyle = ['-', '-', '-', '-']
    ...
    plt.tight_layout()
    plt.savefig('/home/tung/workspace/rlbench/rad/figures/state_vpcpm_{}.pdf'.format(args.env))
    # plt.show()
...
if __name__ == '__main__':
    ...
    experiments = dict(
        finger_spin=[
            '../sac_baselines/s159_logs/finger-spin/state/',
        ...
        cartpole_swingup=[
            '../sac_baselines/s159_logs/cartpole-swingup/state/',
        ...
        reacher_easy=[
            '../sac_baselines/s159_logs/reacher-easy/state/',
        ...
        ball_in_cup_catch=[
            '../sac_baselines/s159_logs/ball_in_cup-catch/state/',
        ...
        cheetah_run=[
            '../sac_baselines/s159_logs/cheetah-run/state/',
        ...
        walker_walk=[
            '../sac_baselines/s159_logs/walker-walk/state/',
