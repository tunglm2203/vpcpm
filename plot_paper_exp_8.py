...
def plot_multiple_results(directories):
    ...
    color_table = ['#9f4800', '#e8000b', '#023eff']
    linestyle = ['-', '-', '-', '-']
...
if __name__ == '__main__':
    ...
    experiments = dict(
        finger_spin=[
            ...
            's131_logs/finger-spin/crop_bs512_from_classification_finetune/',
        ...
        ball_in_cup_catch=[
            ...
            's159_logs/ball_in_cup-catch/crop_bs512_from_classification_finetune/',
        ...
        cheetah_run=[
            ...
            's131_logs/cheetah-run/crop_bs512_from_classification_finetune/',
        ...
        walker_walk=[
            ...
            'logs/walker-walk/crop_bs512_from_classification_finetune',
