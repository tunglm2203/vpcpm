...
def plot_multiple_results(directories):
    ...
    color_table = ['#1ac938', '#ff7c00', '#e8000b', '#9f4800', '#023eff']
    linestyle = ['-', '-', '-', '-', '-']
    ...
    plt.tight_layout()
    plt.savefig('/home/tung/workspace/rlbench/rad/figures/comp_{}.pdf'.format(args.env))
    # plt.show()
...
if __name__ == '__main__':
    ...
    experiments = dict(
        finger_spin=[
            ...
            's131_logs/finger-spin/crop_from_pre_enc_ae_50k_samples_20k_train_finetune/',
            's131_logs/finger-spin/crop_from_pre_enc_cpc_v0_lr1e-3_bs512_50k_samples_50k_train_finetune/',
            's131_logs/finger-spin/crop_from_pre_enc_pm_lr1e-4_bs512_50k_samples_20k_train_finetune/',
        ...
        cartpole_swingup=[
            ...
            's162_logs/cartpole-swingup/crop_from_pre_enc_ae_50k_samples_20k_train_finetune/',
            's162_logs/cartpole-swingup/crop_from_pre_enc_cpc_v0_lr1e-3_bs512_50k_samples_50k_train_finetune/',
            's162_logs/cartpole-swingup/crop_from_pre_enc_pm_lr1e-4_bs512_50k_samples_20k_train_finetune/',
        ...
        reacher_easy=[
            ...
            's162_logs/reacher-easy/crop_from_pre_enc_ae_50k_samples_20k_train_finetune/',
            's162_logs/reacher-easy/crop_from_pre_enc_cpc_v0_lr1e-3_bs512_50k_samples_50k_train_finetune/',
            's162_logs/reacher-easy/crop_from_pre_enc_pm_lr1e-4_bs512_50k_samples_20k_train_finetune/',
        ...
        ball_in_cup_catch=[
            ...
            's41_logs/ball_in_cup-catch/crop_from_pre_enc_ae_50k_samples_20k_train_finetune/',
            's41_logs/ball_in_cup-catch/crop_from_pre_enc_cpc_v0_lr1e-3_bs512_50k_samples_50k_train_finetune.finish/',
            's41_logs/ball_in_cup-catch/crop_from_pre_enc_pm_lr1e-4_bs512_50k_samples_20k_train_finetune/',
        ...
        cheetah_run=[
            ...
            's41_logs/cheetah-run/crop_from_pre_enc_ae_50k_samples_20k_train_finetune/',
            's41_logs/cheetah-run/crop_from_pre_enc_cpc_v0_lr2e-4_bs512_50k_samples_50k_train_finetune/',
            's41_logs/cheetah-run/crop_from_pre_enc_pm_lr1e-4_bs512_50k_samples_20k_train_finetune/',
        ...
        walker_walk=[
            ...
            's131_logs/walker-walk/crop_from_pre_enc_ae_50k_samples_20k_train_finetune/',
            's131_logs/walker-walk/crop_from_pre_enc_cpc_v0_lr1e-3_bs512_50k_samples_50k_train_finetune/',
            's131_logs/walker-walk/crop_from_pre_enc_pm_lr1e-4_bs512_50k_samples_20k_train_finetune/',
