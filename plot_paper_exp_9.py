...
def plot_multiple_results(directories):
    ...
    color_table = ['#1ac938', '#9f4800', '#e8000b', '#023eff']
    linestyle = ['-', '-', '-', '-']
    ...
    plt.tight_layout()
    # plt.savefig('/home/tung/workspace/rlbench/rad/figures/pretrain_cls_{}.pdf'.format(args.env))
    plt.show()
...
if __name__ == '__main__':
    ...
    experiments = dict(
        finger_spin=[
            '',
            's41_logs_dmc/finger-spin/crop_from_pre_enc_cpc_lr1e-3_idm_lr1e-3_bs512_10k_samples_10k_train_finetune/',
            's131_logs/finger-spin/crop_from_pre_enc_cpc_lr1e-3_idm_lr1e-3_bs512_50k_samples_50k_train_finetune/',
        ],
        # cartpole_swingup=[
        #     's162_logs/cartpole-swingup/crop_bs512_from_pre_enc_cpc_lr1e-3_idm_lr1e-3_bs512_10k_samples_10k_train_finetune/',
        #     's162_logs/cartpole-swingup/crop_bs128_from_pre_enc_cpc_lr1e-3_idm_lr1e-3_bs512_25k_samples_25k_train_finetune/',
        ...
        ball_in_cup_catch=[
            's159_logs/ball_in_cup-catch/crop_from_pre_enc_cpc_lr1e-3_idm_lr1e-3_bs512_5k_samples_5k_train_finetune/',
            's159_logs/ball_in_cup-catch/crop_from_pre_enc_cpc_lr1e-3_idm_lr1e-3_bs512_10k_samples_10k_train_finetune/',
            's159_logs/ball_in_cup-catch/crop_from_pre_enc_cpc_lr1e-3_idm_lr1e-3_bs512_25k_samples_25k_train_finetune/',
        ...
        walker_walk=[
            's34_logs/walker-walk/crop_bs512_from_pre_enc_cpc_lr1e-4_idm_lr1e-4_bs512_5k_samples_5k_train_finetune/',
            's34_logs/walker-walk/crop_bs512_from_pre_enc_cpc_lr1e-4_idm_lr1e-4_bs512_10k_samples_10k_train_finetune/',
            's34_logs/walker-walk/crop_bs512_from_pre_enc_cpc_lr1e-4_idm_lr1e-4_bs512_25k_samples_25k_train_finetune/',
