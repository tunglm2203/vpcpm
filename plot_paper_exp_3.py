...
def plot_multiple_results(directories):
    ...
    color_table = ['#1ac938', '#ff7c00', '#e8000b', '#023eff']
    linestyle = ['-', '-', '-', '-']
    ...
    env_lims = dict(
        ...
        cartpole_swingup=[[0, 200000], [1, 950]],
        reacher_easy=[[0, 200000], [1, 1050]],
        ball_in_cup_catch=[[0, 200000], [1, 1050]],
        cheetah_run=[[0, 200000], [1, 600]],
        walker_walk=[[0, 250000], [1, 1050]],
    )
    ...
    plt.tight_layout()
    plt.savefig('/home/tung/workspace/rlbench/rad/figures/abl_{}.pdf'.format(args.env))
    plt.show()
...
if __name__ == '__main__':
    ...
    experiments = dict(
        finger_spin=[
            's131_ablations/finger-spin/crop/',
            # 's131_ablations/finger-spin/crop_from_pre_enc_idm_lr1e-3_bs512_50k_samples_50k_train_finetune/',
            's131_ablations/finger-spin/crop_from_pre_enc_cpc_lr1e-3_bs512_50k_samples_50k_train_finetune/',
            # 's131_ablations/finger-spin/crop_from_pre_enc_cpc_lr1e-3_idm_lr1e-3_bs512_50k_samples_50k_train_finetune/'
        ],
        cartpole_swingup=[
            's162_ablations/cartpole-swingup/crop/',
            # 's162_ablations/cartpole-swingup/crop_from_pre_enc_idm_lr1e-3_bs512_50k_samples_50k_train_finetune/',
            's162_ablations/cartpole-swingup/crop_from_pre_enc_cpc_lr1e-3_bs512_50k_samples_50k_train_finetune/',
            # 's162_ablations/cartpole-swingup/crop_from_pre_enc_cpc_lr1e-3_idm_lr1e-3_bs512_50k_samples_50k_train_finetune/'
        ],
        reacher_easy=[
            's162_ablations/reacher-easy/crop/',
            # 's162_ablations/reacher-easy/crop_from_pre_enc_idm_lr1e-3_bs512_50k_samples_50k_train_finetune/',
            's162_ablations/reacher-easy/crop_from_pre_enc_cpc_lr1e-3_bs512_50k_samples_50k_train_finetune/',
            # 's162_ablations/reacher-easy/crop_from_pre_enc_cpc_lr1e-3_idm_lr1e-3_bs512_50k_samples_50k_train_finetune/'
        ],
        ball_in_cup_catch=[
            's41_ablations/ball_in_cup-catch/crop/',
            # 's41_ablations/ball_in_cup-catch/crop_from_pre_enc_idm_lr1e-3_bs512_50k_samples_50k_train_finetune/',
            's41_ablations/ball_in_cup-catch/crop_from_pre_enc_cpc_lr1e-3_bs512_50k_samples_50k_train_finetune/',
            # 's41_ablations/ball_in_cup-catch/crop_from_pre_enc_cpc_lr1e-3_idm_lr1e-3_bs512_50k_samples_50k_train_finetune/'
        ],
        cheetah_run=[
            's41_ablations/cheetah-run/crop/',
            # 's41_ablations/cheetah-run/crop_from_pre_enc_idm_lr2e-4_bs512_50k_samples_50k_train_finetune/',
            's41_ablations/cheetah-run/crop_from_pre_enc_cpc_lr2e-4_bs512_50k_samples_50k_train_finetune/',
            # 's41_ablations/cheetah-run/crop_from_pre_enc_cpc_lr2e-4_idm_lr2e-4_bs512_50k_samples_50k_train_finetune/'
        ],
        walker_walk=[
            's131_ablations/walker-walk/crop/',
            # 's131_ablations/walker-walk/crop_from_pre_enc_idm_lr1e-4_bs512_50k_samples_50k_train_finetune/',
            's131_ablations/walker-walk/crop_from_pre_enc_cpc_lr1e-4_bs512_50k_samples_50k_train_finetune/',
            # 's131_ablations/walker-walk/crop_from_pre_enc_cpc_lr1e-4_idm_lr1e-4_bs512_50k_samples_50k_train_finetune/'
        ]
    )
